...
// PRIMEIRO PAR DE IMAGENS <./alchemy ./images/cat.jpg ./images/dog.jpg>
...
//Biblioteca para gerar números aleatórios maiores, de 64 bits
// Download em: http://www.math.sci.hiroshima-u.ac.jp/m-mat/MT/mt19937-64.tgz
#include "mt64/mt64.h"
...
double euclidean_distance(RGBpixel p1, RGBpixel p2);
...
int main(int argc, char *argv[])
{
    ...
    init_genrand64(time(0)); // incializa a gerador da biblioteca mt64
   ...
   //comeca versão do trabalho
    ...
    while (counter < 5000) {
        ...
        //distancia pixel cor a e pixel desejado a
